...
class TestNLTKPunktTokenizer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.text = u"Heute ist der 3. Mai 2014 und Dr. Meier hat seinen 43. " \
        ...
        self.snt1 = u"Heute ist der 3. Mai 2014 und Dr. Meier hat seinen 43. " \
            u"Geburtstag."
    ...
    def test_tokenize(self):
        assert_equal(self.tokenizer.tokenize(self.text),
            [['Heute', 'ist', 'der', '3.', 'Mai', '2014', 'und', 'Dr.', 
              'Meier', 'hat', 'seinen', '43.', 'Geburtstag', '.'], ['Ich', 
    ...
    def test_exclude_punc(self):
        assert_equal(self.tokenizer.tokenize(self.text, include_punc=False),
            [['Heute', 'ist', 'der', '3', 'Mai', '2014', 'und', 'Dr', 'Meier', 
              'hat', 'seinen', '43', 'Geburtstag'], ['Ich', 'muss', 
              'unbedingt', 'daran', 'denken', 'Mehl', 'usw', u'für', 'einen', 
              'Kuchen', 'einzukaufen'], ['Aber', 'leider', 'habe', 'ich', 
              'nur', 'noch', 'EUR', '18.50', 'in', 'meiner', 'Brieftasche']])
    ...
    def test_itokenize(self):
        ...
        assert_equal(next(gen), ['Heute', 'ist', 'der', '3.', 'Mai', '2014', 
                                 ...
                                 '43.', 'Geburtstag', '.'])
        assert_equal(next(gen), ['Ich', 'muss', 'unbedingt', 'daran', 'denken',
                                 ',', 'Mehl', ',', 'usw.', u'für', 'einen', 
                                 'Kuchen', 'einzukaufen', '.'])
    ...
    def test_sent_tokenize(self):
     ...
     u'Heute ist der 3. Mai 2014 und Dr. Meier hat seinen 43. Geburtstag.', 
...
class TestPatternTokenizer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.text = "Heute ist der 3. Mai 2014 und Dr. Meier hat seinen 43. " \
            "Geburtstag."
    ...
    def test_tokenize(self):
        assert_equal(self.tokenizer.tokenize(self.text),
         [['Heute','ist', 'der', '3', '.'], 
         ['Mai', '2014', 'und', 'Dr.', 'Meier', 'hat', 'seinen', '43', '.'], 
         ['Geburtstag', '.']])

    def test_exclude_punc(self):
        assert_equal(self.tokenizer.tokenize(self.text, include_punc=False),
          [['Heute', 'ist', 'der', '3'], ['Mai', '2014', 'und', 'Dr', 'Meier', 
            'hat', 'seinen', '43'], ['Geburtstag']])
